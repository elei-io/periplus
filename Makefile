...
catalogue-check:
	...
	PERIPLUS_DUCKLAKE_S3_ENDPOINT="$${PERIPLUS_DUCKLAKE_S3_ENDPOINT:-127.0.0.1:$${LAKE_ALLUXIO_S3_PORT:-7070}/api/v1/s3}" \
	PERIPLUS_DUCKLAKE_S3_REGION="$${PERIPLUS_DUCKLAKE_S3_REGION:-us-east-1}" \
	PERIPLUS_DUCKLAKE_S3_KEY_ID="$${PERIPLUS_DUCKLAKE_S3_KEY_ID:-alluxio}" \
