...
check:
	cd backend && uv run python -m compileall actions artifacts api cli db tasks urls crawls data_schemas query_schemas crawl_policies metrics observability worker
