...
SELECT k.content_id, (SELECT count(*) FROM public_v1.html_node n WHERE n.content_id=k.content_id AND n.content_id >= '0' AND n.content_id < '1') AS nodes FROM keys k;
