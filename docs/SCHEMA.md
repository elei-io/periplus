...
The stable semantic interface installed as versioned DuckLake views and macros:
...
The portable catalogue definitions are authoritative. Optional native optimization may improve
their plans but does not define their semantics. See [`QUERY.md`](QUERY.md).
