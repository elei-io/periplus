...
- `scrape` is currently the page acquisition primitive. The durable target is a shared crawl acquisition chokepoint that records URLs, crawls, reusable artifacts, and task-run usage in Postgres.
