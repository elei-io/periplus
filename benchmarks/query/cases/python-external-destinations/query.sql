SELECT regexp_extract(l.target_url, '^https?://([^/:]+)', 1) AS target_hostname,
...
WHERE c.url LIKE 'https://docs.python.org/%'
 AND regexp_extract(l.target_url, '^https?://([^/:]+)', 1) <> 'docs.python.org'
