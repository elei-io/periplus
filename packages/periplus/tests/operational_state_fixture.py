...
from periplus.materialization.models import MaterializationStateRecord, MaterializationAppliedBatchRecord, MaterializationRunRecord
...
def operational_state(test):
    ...
    for model in (MaterializationStateRecord, MaterializationAppliedBatchRecord, MaterializationRunRecord,
