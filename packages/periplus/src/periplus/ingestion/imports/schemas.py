...
class ImportSpec(BaseModel):
    ...
    urls: tuple[Annotated[str, Field(max_length=4096)], ...] = Field(min_length=1, max_length=100)
    captured_from: AwareDatetime
    captured_until: AwareDatetime
    max_download_bytes: int = Field(default=64 * 1024 * 1024, ge=1, le=1024 * 1024 * 1024)
