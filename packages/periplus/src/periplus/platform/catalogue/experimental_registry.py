"""Independent experimental catalogue. Promote reviewed definitions into a new public_vN registry."""

from periplus.platform.catalogue.public import CatalogueObject
from periplus.platform.catalogue.experimental_helpers import HELPERS
...
def _view(name, columns, comment, requires=(), *, content_local=False):
    return CatalogueObject(
        ...
        schema="experimental", comment=comment, column_comments=columns, requires_relations=frozenset(requires),
