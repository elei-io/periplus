CREATE OR REPLACE VIEW experimental.html_select_option AS
WITH owned AS (
    SELECT o.content_id, o.node_index, o.subtree_end_index, o.attributes, o.text,
           max(s.node_index) AS select_node_index
    FROM experimental.html_element o
    JOIN experimental.html_element s ON s.content_id = o.content_id
