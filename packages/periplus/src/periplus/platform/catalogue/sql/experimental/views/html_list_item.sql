CREATE OR REPLACE VIEW experimental.html_list_item AS
WITH items AS (
    ...
    FROM experimental.html_list l
    JOIN experimental.html_element i ON i.content_id = l.content_id AND i.parent_index = l.node_index
