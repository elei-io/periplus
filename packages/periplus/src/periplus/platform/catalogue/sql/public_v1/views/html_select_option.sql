...
WITH owned AS (
    SELECT o.content_id, o.node_index, o.subtree_end_index, o.attributes,
    ...
    GROUP BY o.content_id, o.node_index, o.subtree_end_index, o.attributes
), indexed AS (
...
FROM indexed o
LEFT JOIN public_v1.html_node n ON n.content_id = o.content_id
 AND n.node_index > o.node_index AND n.node_index < o.subtree_end_index AND n.node_type = 'text'
GROUP BY o.content_id, o.node_index, o.select_node_index, o.option_index, o.attributes;
