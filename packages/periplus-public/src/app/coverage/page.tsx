...
export async function generateMetadata({ searchParams }: PageProps<"/coverage">): Promise<Metadata> {
  ...
  return pageMetadata("/coverage", "Coverage", "Explore the sources in Periplus’s shared web databank, follow coverage requests, and request the data you need.", !hasWorkspaceInput(params, ["request"]))
}
