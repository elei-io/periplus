export const docsSqlPatterns = [
  ...
  },
  {
    ...
    "sql": "SELECT document_id, node_index, tag, text FROM html_element WHERE tag = 'h1' AND text ILIKE '%robot%' ORDER BY document_id, node_index LIMIT 100;"
  },
  {
