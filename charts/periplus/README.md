...
Route public and admin through separate TLS ingresses. Protect the admin UI and all proxied
...
fixed `replicas` remain effective until enabled. Janitor stays one replica with
