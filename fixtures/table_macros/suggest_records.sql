-- atlas:description=Discovers and ranks repeated record structures on captured pages matching a URL or URL pattern, returning candidate selectors, inferred fields, examples, scores, and ready-to-run extraction SQL.
