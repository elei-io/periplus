...
export ATLAS_DUCKLAKE_METADATA_PATH="${ATLAS_DUCKLAKE_METADATA_PATH:-postgres:dbname=lake host=127.0.0.1 port=${LAKE_POSTGRES_PORT:-55433} user=lake password=lake_local}"
export ATLAS_DUCKLAKE_METADATA_SCHEMA="${ATLAS_DUCKLAKE_METADATA_SCHEMA:-ducklake}"
export ATLAS_DUCKLAKE_DATA_PATH="${ATLAS_DUCKLAKE_DATA_PATH:-s3://lake/}"
export ATLAS_DUCKLAKE_S3_ENDPOINT="${ATLAS_DUCKLAKE_S3_ENDPOINT:-127.0.0.1:${LAKE_S3_PORT:-7070}}"
export ATLAS_DUCKLAKE_S3_REGION="${ATLAS_DUCKLAKE_S3_REGION:-us-east-1}"
export ATLAS_DUCKLAKE_S3_KEY_ID="${ATLAS_DUCKLAKE_S3_KEY_ID:-lake}"
export ATLAS_DUCKLAKE_S3_SECRET_ACCESS_KEY="${ATLAS_DUCKLAKE_S3_SECRET_ACCESS_KEY:-lake-secret}"
