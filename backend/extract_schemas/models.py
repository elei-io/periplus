...
class ExtractSchema(Base):
    __tablename__ = "extract_schemas"
    __table_args__ = (
        Index("ix_extract_schemas_enabled", "enabled"),
        Index("ix_extract_schemas_match", "match"),
        Index("ix_extract_schemas_domain", "domain"),
        Index("ix_extract_schemas_prompt_hash", "prompt_hash"),
        Index("ix_extract_schemas_schema_type", "schema_type"),
    )
    ...
    task_runs = relationship("TaskRun", back_populates="extract_schema", foreign_keys="TaskRun.extract_schema_id")
