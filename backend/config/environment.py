...
DEFAULTS: Final[dict[str, str | None]] = {
    ...
    "ATLAS_INGEST_DEAD_LETTER_TTL_SECONDS": str(30 * 24 * 60 * 60),
    "ATLAS_INGEST_DEAD_LETTER_MAX_BYTES": str(256 * 1024 * 1024),
    ...
    "ATLAS_CRAWL_POLICY_LEASE_SECONDS": "120",
    "ATLAS_CRAWL_POLICY_HEARTBEAT_SECONDS": "30",
    ...
    "ATLAS_CRAWL_WORKER_METRICS_PORT": "9090",
    "ATLAS_CATALOG_WORKER_METRICS_PORT": "9091",
    "ATLAS_CATALOG_WORKER_HEALTH_HOST": "0.0.0.0",
    "ATLAS_CATALOG_WORKER_HEALTH_PORT": "9092",
    "ATLAS_CATALOG_WORKER_HEALTH_HEARTBEAT_TIMEOUT_SECONDS": "5",
    "ATLAS_CATALOG_WORKER_HEALTH_PROBE_INTERVAL_SECONDS": "10",
    "ATLAS_CATALOG_WORKER_HEALTH_PROBE_TIMEOUT_SECONDS": "2",
    "ATLAS_MAINTENANCE_WORKER_ID": None,
    ...
    "ATLAS_MATERIALIZATION_COMMIT_BATCH_ITEMS": "20",
    "ATLAS_MATERIALIZATION_COMMIT_BATCH_BYTES": str(128 * 1024 * 1024),
    "ATLAS_MATERIALIZATION_COMMIT_BATCH_WAIT_SECONDS": "5",
    "ATLAS_MATERIALIZATION_BACKFILL_PAGE_SIZE": "1000",
    "ATLAS_MATERIALIZATION_BACKFILL_SCOPES_PER_MINUTE": "60",
    "ATLAS_MATERIALIZATION_STREAM_REPLICAS": "1",
    "ATLAS_MATERIALIZATION_ACK_WAIT_SECONDS": "60",
    "ATLAS_MATERIALIZATION_MAX_DELIVER": "5",
    "ATLAS_MATERIALIZATION_MAX_LIVE_DEFINITIONS": "32",
    "ATLAS_MATERIALIZATION_DEAD_LETTER_MAX_BYTES": str(256 * 1024 * 1024),
    "ATLAS_MATERIALIZATION_DEAD_LETTER_TTL_SECONDS": str(30 * 24 * 60 * 60),
