...
DEFAULTS: Final[dict[str, str | None]] = {
    ...
    "ATLAS_MATERIALIZATION_ATTEMPT_TTL_SECONDS": str(7 * 24 * 60 * 60),
    "ATLAS_MATERIALIZATION_ATTEMPT_MAX_BYTES": str(64 * 1024 * 1024),
    ...
    "ATLAS_DUCKLAKE_CDC_VERSION": "ducklake_cdc 0.5.4",
}
