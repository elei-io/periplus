...
from atlas.ingestion.queue import crawl_ingestion_job
from atlas.platform.messaging.catalogue_queue import INGEST_SUBJECT
from atlas.crawl.runtime.graph_models import (
    CrawlRequestRecord,
...
class GraphRuntimeStore:
    ...
    def progress_snapshot(self, run_id: UUID) -> tuple[list, list]:
        from atlas.crawl.runtime.graph_progress import (
            EdgeProgress,
            NodeActivity,
            NodeProgress,
        )
