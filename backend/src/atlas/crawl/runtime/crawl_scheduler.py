...
from atlas.crawl.control.crawl_graphs.service import freeze_graph
from atlas.crawl.control.crawl_schedules.models import CrawlSchedule
from atlas.crawl.control.crawl_schedules.schemas import schedule_timing_adapter
...
from atlas.crawl.runtime.graph_runs import create_graph_run, resolve_policy_snapshots
    ...
    *,
    ...
    with SessionLocal() as session:
        ...
        missed = expected_occurrence < now - timedelta(
            seconds=get_float("ATLAS_SCHEDULE_MISFIRE_GRACE_SECONDS")
        )
