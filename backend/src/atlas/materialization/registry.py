"""Auto-discovered, one-file Atlas materialization registry."""
...
from atlas.materialization.document_projection import VisitBatchContext
...
def discover_projections(
    package_name: str = "atlas.materialization.projections",
