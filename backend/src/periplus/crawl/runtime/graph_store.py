...
from periplus.platform.config.performance import CRAWL_RUN_ACQUISITION_PENDING_LIMIT
from periplus.platform.postgres.session import SessionLocal
from periplus.platform.catalogue import CrawlRecord
from periplus.platform.catalogue.records import canonical_json
from periplus.ingestion.queue import crawl_ingestion_job
from periplus.platform.messaging.catalogue_queue import INGEST_SUBJECT
from periplus.crawl.runtime.graph_models import (
    CrawlRequestRecord,
...
class GraphRuntimeStore:
    ...
    def admit_request(
        ...
        *,
        ...
        from periplus.crawl.runtime.graph_runs import deterministic_request_id
    ...
    def progress_snapshot(self, run_id: UUID) -> tuple[list, list]:
        from periplus.crawl.runtime.graph_progress import (
            EdgeProgress,
            NodeActivity,
            NodeProgress,
        )
