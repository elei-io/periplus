...
from periplus.platform.config import get_optional, get_str


async def connect_nats(*, connect_timeout: int = 2):
    """Connect to the Periplus namespace used by application runtimes."""

    return await connect_configured_nats(
        url_name="PERIPLUS_NATS_URL",
        seed_name="PERIPLUS_NATS_SEED",
