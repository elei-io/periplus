...
DEFAULTS: Final[dict[str, str | None]] = {
    ...
    "PERIPLUS_GRAPH_MAX_RUN_SECONDS": str(7 * 24 * 60 * 60),
    "PERIPLUS_GRAPH_RUN_RETENTION_SECONDS": str(30 * 24 * 60 * 60),
    "PERIPLUS_GRAPH_STREAM_REPLICAS": "1",
    "PERIPLUS_GRAPH_WORK_MAX_BYTES": str(2 * 1024 * 1024 * 1024),
    "PERIPLUS_CRAWL_MAX_DELIVER": "5",
    "PERIPLUS_GRAPH_WORKER_MAX_BYTES": str(64 * 1024 * 1024),
    "PERIPLUS_SCHEDULE_POLL_SECONDS": "5",
    "PERIPLUS_SCHEDULE_MISFIRE_GRACE_SECONDS": "60",
    ...
    "PERIPLUS_AI_MODEL": "openai:gpt-5.6-sol",
    "PERIPLUS_AI_MODEL_TIMEOUT_SECONDS": "180",
    "PERIPLUS_AI_REQUEST_LIMIT": "32",
    "PERIPLUS_AI_TOOL_CALL_LIMIT": "24",
    "OPENAI_API_KEY": None,
