...
class CatalogueScalarMacroDefinition(Base):
    __tablename__ = "catalogue_scalar_macros"
    __table_args__ = (
        UniqueConstraint("slug", name="uq_catalogue_scalar_macro_slug"),
        UniqueConstraint(
            "schema_name", "macro_name", name="uq_catalogue_scalar_macro_name"
        ),
        UniqueConstraint("fixture_path", name="uq_catalogue_scalar_macros_fixture_path"),
        Index("ix_catalogue_scalar_macros_updated_at", "updated_at"),
    )
